...
public class ModBlocks {
  ...
  public static final RegistryObject<Block> EMPTY_POTION_BLOCK =
      registerBlock(
          "empty_potion_block",
          () ->
              new Block(
  ...
  public static final RegistryObject<MilkPotionBlock> MILK_POTION_BLOCK =
      registerBlock("milk_potion_block", MilkPotionBlock::new);
